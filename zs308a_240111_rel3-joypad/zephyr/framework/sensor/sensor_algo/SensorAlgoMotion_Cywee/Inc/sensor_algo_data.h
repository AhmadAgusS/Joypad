...
#define _code_rom_start			Load$$RX_RAM$$Base
#define _code_rom_end				Load$$RX_RAM$$Limit
#define _code_ram_start			Image$$RX_RAM$$Base
#define _code_ram_end				Image$$RX_RAM$$Limit
...
extern char _code_rom_start[];
extern char _code_rom_end[];
extern char _code_ram_start[];
extern char _code_ram_end[];
