...
//constants
/******************************************************************************/
//#define DBG(...)			if (hr_algo_get_os_api()->dbgOutput) hr_algo_get_os_api()->dbgOutput(__VA_ARGS__)
...
void handle_hb_mode_result(ST_HB_RES *stHbRes, GS32 rawdata_ptr[][DBG_MCU_MODE_PKG_LEN], GU16 rawdata_len)
{
	...
	os_api->hb_handler(stHbRes->uchHbValue, stHbRes->uchAccuracyLevel, stHbRes->uchWearingQuality);
...
void handle_spo2_mode_result(ST_SPO2_RES *pstSpo2Res, GS32 rawdata_ptr[][DBG_MCU_MODE_PKG_LEN], GU16 rawdata_len)
{
	...
	os_api->spo2_handler(pstSpo2Res->uchSpo2, pstSpo2Res->usSpo2RVal, pstSpo2Res->uchHbValue, pstSpo2Res->uchHbConfidentLvl, pstSpo2Res->usHrvRRVal,  pstSpo2Res->uchHrvConfidentLvl, pstSpo2Res->uchHrvcnt, pstSpo2Res->usSpo2RVal);
}
#else
/// handle spo2 mode algorithm result
