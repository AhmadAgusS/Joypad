...
#define SENSOR_DEV_HR_GH3011                                                       \
	...
	{ "GH3011",  GH3011_ADR,2,2,   0x0028,0x3100,  REG_NULL,0x0,  REG_NULL,16,0x0,1000 }, \
	/*[io] bus(type,id,cs)  pwr(io,val)  rst(io,val,lt,ht)  int(io,mode,mfp)*/     \
	{ BUS_I2C,1,0,          HR_POWER,1,  HR_RESET,0,10,10,  HR_ISR, 0, 0 },        \
...
//sensor function
/******************************************************************************/
int gh3011_cvt(float *val, uint8_t *buf, uint16_t len);
