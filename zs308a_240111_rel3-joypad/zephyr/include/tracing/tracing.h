...
#define SYS_TRACE_ID_VIEW_COMPRESS           (53u + SYS_TRACE_ID_USR_OFFSET)
#define SYS_TRACE_ID_VIEW_DECOMPRESS         (54u + SYS_TRACE_ID_USR_OFFSET)
#define SYS_TRACE_ID_VIEW_SWAPBUF            (55u + SYS_TRACE_ID_USR_OFFSET)
#define SYS_TRACE_ID_VIEW_UPDATE             (56u + SYS_TRACE_ID_USR_OFFSET)
