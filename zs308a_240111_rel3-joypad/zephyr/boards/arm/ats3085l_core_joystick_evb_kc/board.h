...
#define CONFIG_TPKEY_ISR_GPIO		GPIO_CFG_MAKE(CONFIG_GPIO_B_NAME, 26, GPIO_ACTIVE_LOW, 1)
#define CONFIG_TPKEY_RESET_GPIO		GPIO_CFG_MAKE(CONFIG_GPIO_B_NAME, 25, GPIO_ACTIVE_LOW, 1)
...
#define CONFIG_GPIOKEY_MFP    PIN_MFP_SET(GPIO_24,   GPIOKEY_MFP_PU_CFG), \
							  PIN_MFP_SET(GPIO_49,   GPIOKEY_MFP_PU_CFG), \
							  PIN_MFP_SET(GPIO_50,   GPIOKEY_MFP_PU_CFG)
