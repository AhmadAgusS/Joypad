...
#define CONFIG_I2C_0_TXDMA_CHAN  0xff
#define CONFIG_I2C_0_RXDMA_CHAN  0xff
#define CONFIG_I2C_0_DMA_ID    19

#define CONFIG_I2C_1_USE_DMA   0
#define CONFIG_I2C_1_TXDMA_CHAN  0xff
#define CONFIG_I2C_1_RXDMA_CHAN  0xff
...
#define CONFIG_AUDIO_DAC_0_RIGHT_MUTE           (1)
 ...
 *   - 0: select ADC2 for AEC
 *   - 1: select ADC3 for AEC
 */
#define CONFIG_AUDIO_ADC_0_AEC_SEL              (0)
...
#define CONFIG_PANEL_FULL_SCREEN_OPT_AREA \
	{ \
		{ 122 - CONFIG_PANEL_OFFSET_X,   0 - CONFIG_PANEL_OFFSET_Y, 331 - CONFIG_PANEL_OFFSET_X,  25 - CONFIG_PANEL_OFFSET_Y }, \
		{  66 - CONFIG_PANEL_OFFSET_X,  26 - CONFIG_PANEL_OFFSET_Y, 387 - CONFIG_PANEL_OFFSET_X,  65 - CONFIG_PANEL_OFFSET_Y }, \
		{  26 - CONFIG_PANEL_OFFSET_X,  66 - CONFIG_PANEL_OFFSET_Y, 427 - CONFIG_PANEL_OFFSET_X, 121 - CONFIG_PANEL_OFFSET_Y }, \
		{   0 - CONFIG_PANEL_OFFSET_X, 122 - CONFIG_PANEL_OFFSET_Y, 453 - CONFIG_PANEL_OFFSET_X, 331 - CONFIG_PANEL_OFFSET_Y }, \
		{  26 - CONFIG_PANEL_OFFSET_X, 332 - CONFIG_PANEL_OFFSET_Y, 427 - CONFIG_PANEL_OFFSET_X, 387 - CONFIG_PANEL_OFFSET_Y }, \
		{  66 - CONFIG_PANEL_OFFSET_X, 388 - CONFIG_PANEL_OFFSET_Y, 387 - CONFIG_PANEL_OFFSET_X, 427 - CONFIG_PANEL_OFFSET_Y }, \
		{ 122 - CONFIG_PANEL_OFFSET_X, 428 - CONFIG_PANEL_OFFSET_Y, 331 - CONFIG_PANEL_OFFSET_X, 453 - CONFIG_PANEL_OFFSET_Y }, \
	}
#else
#define CONFIG_PANEL_FULL_SCREEN_OPT_AREA \
	{ \
		{ 66 - CONFIG_PANEL_OFFSET_X,   0 - CONFIG_PANEL_OFFSET_Y, 387 - CONFIG_PANEL_OFFSET_X,  65 - CONFIG_PANEL_OFFSET_Y }, \
		{  0 - CONFIG_PANEL_OFFSET_X,  66 - CONFIG_PANEL_OFFSET_Y, 453 - CONFIG_PANEL_OFFSET_X, 387 - CONFIG_PANEL_OFFSET_Y }, \
		{ 66 - CONFIG_PANEL_OFFSET_X, 388 - CONFIG_PANEL_OFFSET_Y, 387 - CONFIG_PANEL_OFFSET_X, 453 - CONFIG_PANEL_OFFSET_Y }, \
	}
#endif
 ...
 *   - 5: HOSC/128
 */
#define CONFIG_PMUADC_CLOCK_SOURCE               (5)
