...
#endif //IS_ENABLED(CONFIG_SPI_FLASH_0)
...
#if (CONFIG_SPI_FLASH_1 == 1) || IS_ENABLED(CONFIG_SPI_FLASH_0) || IS_ENABLED(CONFIG_SPI_FLASH_2)
...
#endif //(CONFIG_SPI_FLASH_1 == 1) || IS_ENABLED(CONFIG_SPI_FLASH_0) || IS_ENABLED(CONFIG_SPI_FLASH_2)
...
#if (CONFIG_SPI_FLASH_1 == 1) || IS_ENABLED(CONFIG_SPI_FLASH_0)
...
#endif //(CONFIG_SPI_FLASH_1 == 1) || IS_ENABLED(CONFIG_SPI_FLASH_0)
