        ...
        size_t argc, char **argv)
{
    ...
    // printk("\n");
    if(ret)
        LOG_ERR("spi test error\n");
    else
        LOG_INF("spi test pass\n");
...
SHELL_CMD_REGISTER(test_spi_master, &test_spi_cmds, "SPI Master commands", NULL);
