...
void test_blend_fg(void)
{
	...
	dma2d.output_cfg.mode = HAL_DMA2D_M2M_BLEND_FG;
	...
	while (1) {
		...
		hal_dma2d_blending_start(&dma2d, test_color[color_cnt].full, dst_buf.addr,
				dst_buf.addr, dst_buf.desc.width, dst_buf.desc.height);
