...
typedef int os_tid_t;
typedef int os_mutex;
typedef int os_sem;
typedef int os_timer;
typedef int os_delayed_work;
typedef int os_work;
typedef int os_work_q;
typedef int os_msgq;
typedef int os_mbox;
typedef int os_pipe;
typedef int os_fifo;
typedef int os_lifo;
typedef int os_mbox_msg;
typedef int os_thread;

#define OS_MUTEX_DEFINE(name) void *name; 
#define OS_SEM_DEFINE(name, initial_count, count_limit) void *name;
#else
#define OS_ORI_FOREVER K_FOREVER
...
typedef void (*os_work_handler_t)(os_work *work);
