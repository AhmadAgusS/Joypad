...
#ifndef BT_WATCH_SRC_WIDGETS_COMPASS_H_
#define BT_WATCH_SRC_WIDGETS_COMPASS_H_
...
typedef struct {
	...
	/* used when hardware rotation unavailable */
	sw_matrix_t matrix;
} compass_t;
...
#endif /* BT_WATCH_SRC_WIDGETS_COMPASS_H_ */
