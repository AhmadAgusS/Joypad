...
static void invalidate_image_area(lv_obj_t * obj)
{
	...
	abs_area.x1 = img->area.x1 + obj->coords.x1;
	abs_area.y1 = img->area.y1 + obj->coords.y1;
	abs_area.x2 = img->area.x2 + obj->coords.x1;
	abs_area.y2 = img->area.y2 + obj->coords.y1;
