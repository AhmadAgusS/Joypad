...
#ifndef BT_WATCH_SRC_WIDGETS_WATCH_LIST_H_
#define BT_WATCH_SRC_WIDGETS_WATCH_LIST_H_
 ...
 * @param icon_src icon image before the text
 * @param text_src text image of the list element
 ...
 * @param sty_text style of the text
 * @return pointer to the new list element which can be customized (a button)
 */
...
#endif /* BT_WATCH_SRC_WIDGETS_WATCH_LIST_H_ */
