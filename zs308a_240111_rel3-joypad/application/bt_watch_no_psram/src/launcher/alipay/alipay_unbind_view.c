...
#if DEF_UI_WIDTH < 454
		lvgl_bitmap_font_open(&data->font, DEF_FONT24_FILE);
#else
		lvgl_bitmap_font_open(&data->font, DEF_FONT32_FILE);
#endif
		for (idx = 0; idx < 2; idx++) {
