 ...
 *      DEFINES
 *********************/
#ifndef CONFIG_CLOCK_DEF_REFR_PERIOD
#  define CONFIG_CLOCK_DEF_REFR_PERIOD 1000
#endif
...
{
    SetTimer(NULL, VSYNC_TIMER_ID, 16, _vsync_period_callback);
    SetTimer(NULL, CLOCK_TIMER_ID, CONFIG_CLOCK_DEF_REFR_PERIOD, _clock_period_callback);
...
bool native_window_get_pointer_state(input_dev_data_t* data)
{
    ...
    lv_win32_get_mouse_state(&pressed, &x, &y);
