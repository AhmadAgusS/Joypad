...
extern int _wxpay_main_view_handler(uint16_t view_id, uint8_t msg_id, void* msg_data);
extern int _wxpay_bind_view_handler(uint16_t view_id, uint8_t msg_id, void* msg_data);
extern int _wxpay_pay_view_handler(uint16_t view_id, uint8_t msg_id, void* msg_data);
extern int _wxpay_unbind_view_handler(uint16_t view_id, uint8_t msg_id, void* msg_data);
...
view_entry_t __view_entry_table[] = {
    ...
    },
    {
        ...
        .proc = _wxpay_unbind_view_handler,
        .get_state = NULL,
        .key_map = NULL,
