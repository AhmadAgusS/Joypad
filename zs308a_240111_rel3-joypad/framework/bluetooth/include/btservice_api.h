 ...
 *===========================================================================*/
/**
 * @brief clear all sdp registered records
 *
 * This routine clear all sdp registered records.
 *
 * @return 0 excute successed
 */
int btif_clear_all_sdp_record(void);
...
/* note that BT_HID_MAX_MTU in hid.h should be larger than BT_HID_REPORT_DATA_LEN */
