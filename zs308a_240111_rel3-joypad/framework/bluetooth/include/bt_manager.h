...
/** @brief Clear all registered Service Record.
 *
 *  Clear all registered Service Record. 
 *
 * @return 0 means it's done.
 */
void bt_manager_clear_all_sdp_record(void);
...
static inline int bt_manager_hid_send_key(uint8_t report_id, uint8_t func_id)
{
	return -1;
}
#endif
