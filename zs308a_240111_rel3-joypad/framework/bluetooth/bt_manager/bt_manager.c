...
static int bt_mananger_btdev_error(int err)
{
	...
	//msg.type = MSG_BT_DEVICE_ERROR;		/* Not ready for device reinit, replace by reboot */
...
static int bt_temp_comp_init(void)
{
