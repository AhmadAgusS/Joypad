...
static int _ui_service_send_async_ext(uint16_t view_id, uint8_t msg_id,
		uint8_t msg_flag, uint32_t msg_data, MSG_CALLBAK msg_cb)
{
	struct app_msg msg = {
		.type = MSG_UI_EVENT,
		.sender = view_id,
...
static int _ui_service_send_async(uint16_t view_id, uint8_t msg_id,
		uint8_t msg_flag, uint32_t msg_data)
{
	return _ui_service_send_async_ext(view_id, msg_id, msg_flag, msg_data, NULL);
}
...
int ui_manager_send_async2(uint16_t view_id, uint8_t msg_id, uint32_t msg_data, MSG_CALLBAK msg_cb)
{
	...
	return _ui_service_send_async_ext(view_id, msg_id, 0, msg_data, msg_cb);
#else
	return -ENOSYS;
#endif
}
...
int ui_manager_send_sync(uint16_t view_id, uint8_t msg_id, uint32_t msg_data)
{
	...
	return _ui_service_send_sync(view_id, msg_id, 0, msg_data, NULL);
#else
	return -ENOSYS;
#endif
}
...
int ui_manager_send_sync2(uint16_t view_id, uint8_t msg_id, uint32_t msg_data, MSG_CALLBAK msg_cb)
{
	...
	return _ui_service_send_sync(view_id, msg_id, 0, msg_data, msg_cb);
#else
	return -ENOSYS;
#endif
}
...
{
#ifdef CONFIG_UI_SERVICE
	return _ui_service_send_async(view_id, MSG_VIEW_SET_DRAG_ATTRIBUTE, keep_pos, drag_attribute);
#else
	return 0;
#endif
}
...
int ui_view_send_user_msg(uint16_t view_id, uint8_t msg_id, void *msg_data)
{
	...
	if (msg_id >= MSG_VIEW_USER_OFFSET) {
		return _ui_service_send_async(view_id, msg_id, 0, (uintptr_t)msg_data);
	}
...
{
#ifdef CONFIG_UI_SERVICE
	return _ui_service_send_async(msgbox_id, MSG_MSGBOX_POPUP, 0, (uintptr_t)user_data);
#else
	return 0;
#endif
}
...
{
#ifdef CONFIG_UI_SERVICE
	return _ui_service_send_async(msgbox_id, MSG_MSGBOX_PAINT, 0, reason);
#else
	return 0;
#endif
}
...
{
#ifdef CONFIG_UI_SERVICE
	return _ui_service_send_async(0, MSG_DISPLAY_LOCK, 0, 1);
#else
	return 0;
#endif
}
...
{
#ifdef CONFIG_UI_SERVICE
	return _ui_service_send_async(0, MSG_VIEW_SET_CALLBACK, UI_CB_SCROLL, (uintptr_t)callback);
#else
	return 0;
#endif
}
...
{
#ifdef CONFIG_UI_SERVICE
	return _ui_service_send_async(0, MSG_VIEW_SET_CALLBACK, UI_CB_MONITOR, (uintptr_t)callback);
#else
	return 0;
#endif
}
...
{
#ifdef CONFIG_UI_SERVICE
	return _ui_service_send_async(0, MSG_VIEW_SET_BUF_COUNT, 0, buf_count);
#else
	return -ENOSYS;
#endif
}
...
int ui_gesture_set_scroll_dir(uint8_t dir)
{
	...
	if (is_in_ui_thread()) {
		...
		return _ui_service_send_async(0, MSG_GESTURE_SET_SCROLL_DIR, 0, dir);
	}
#else
	return -ENOSYS;
#endif
...
int ui_gesture_lock_scroll(void)
{
	...
	if (is_in_ui_thread()) {
		...
		return _ui_service_send_sync(0, MSG_GESTURE_LOCK_SCROLL, 0, 1, NULL);
	}
#else
	return -ENOSYS;
#endif
