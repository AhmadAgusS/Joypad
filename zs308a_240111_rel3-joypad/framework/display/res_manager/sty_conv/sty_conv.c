...
static int _parse_bitmap(char* sty_data, sty_picture_t* pic)
{
	...
	case RES_TYPE_A8_LZ4:
		...
		break;
	case RES_TYPE_PIC_ARGB6666:
	case RES_TYPE_PIC_ARGB6666_LZ4:
		pic->bytes_per_pixel = 3;
    ...
    if((res_entry.type == RES_TYPE_PIC_LZ4) || (res_entry.type == RES_TYPE_PIC_ARGB8888_LZ4) || (res_entry.type == RES_TYPE_A8_LZ4) || (res_entry.type == RES_TYPE_PIC_ARGB6666_LZ4))
    {
