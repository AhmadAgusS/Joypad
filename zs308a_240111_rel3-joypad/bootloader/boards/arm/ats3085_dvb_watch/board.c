...
static const struct acts_pin_config board_pin_reset_defautl[] = {
	...
	/*SPI3 IO2*/
	PIN_MFP_SET(GPIO_8,   GPIO_PIN_DEFAULT_VAL),
	/*SPI3 IO3*/
	PIN_MFP_SET(GPIO_9,   GPIO_PIN_DEFAULT_VAL),
	/*SPI3 SS*/
	PIN_MFP_SET(GPIO_10,  GPIO_PIN_DEFAULT_VAL),
	/*SPI3 CLK*/
	PIN_MFP_SET(GPIO_11,  GPIO_PIN_DEFAULT_VAL),
	/*SPI3 IO1*/
	PIN_MFP_SET(GPIO_12,  GPIO_PIN_DEFAULT_VAL),
	/*SPI3 IO0*/
	PIN_MFP_SET(GPIO_13,  GPIO_PIN_DEFAULT_VAL),
	/*SPINAND POWER*/
	PIN_MFP_SET(GPIO_64,  GPIO_PIN_DEFAULT_VAL),
#endif
};
...
{
#if IS_ENABLED(CONFIG_SPINAND_3)
	pinmux_info->pins_config = board_pin_reset_defautl;
	pinmux_info->pins_num = ARRAY_SIZE(board_pin_reset_defautl);
#endif
}
