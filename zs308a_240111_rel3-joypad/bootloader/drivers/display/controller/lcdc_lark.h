...
#define LCD_IF_SEL_CPU_I8080      LCD_IF_SEL(0)
#define LCD_IF_SEL_CPU_M6880      LCD_IF_SEL(1)
#define LCD_IF_SEL_SPI            LCD_IF_SEL(3)
#define LCD_IF_MASK               LCD_IF_SEL(3)

#define LCD_IF_FORMAT_SEL(x)      ((uint32_t)(x) << 4)
#define LCD_IF_FORMAT_RGB565      LCD_IF_FORMAT_SEL(0)
#define LCD_IF_FORMAT_RGB666      LCD_IF_FORMAT_SEL(1)
#define LCD_IF_FORMAT_RGB888      LCD_IF_FORMAT_SEL(2)
#define LCD_IF_FORMAT_MASK        LCD_IF_FORMAT_SEL(3)
...
#define LCD_CPU_OPT_SEL(x)          ((uint32_t)(x) << 8)
#define LCD_CPU_RD                  LCD_CPU_OPT_SEL(0)
#define LCD_CPU_RD_DELAY_1CLK       LCD_CPU_OPT_SEL(1)
#define LCD_CPU_RD_MASK             LCD_CPU_OPT_SEL(1)
...
#define LCD_CPU_INPUT_SRC_SEL(x)    ((uint32_t)(x) << 2)
#define LCD_CPU_INPUT_SRC_SEL_AHB   LCD_CPU_INPUT_SRC_SEL(0)
#define LCD_CPU_INPUT_SRC_SEL_DE    LCD_CPU_INPUT_SRC_SEL(1)
#define LCD_CPU_INPUT_SRC_SEL_DMA   LCD_CPU_INPUT_SRC_SEL(2)
#define LCD_CPU_INPUT_SRC_MASK      LCD_CPU_INPUT_SRC_SEL(3)
...
#define LCD_SPI_QUAD                  LCD_SPI_TYPE_SEL(4)
#define LCD_SPI_QUAD_SYNC             LCD_SPI_TYPE_SEL(5)
...
#define LCD_SPI_INPUT_SRC_SEL_AHB     LCD_SPI_SRC_SEL(0)
#define LCD_SPI_INPUT_SRC_SEL_DE      LCD_SPI_SRC_SEL(1)
#define LCD_SPI_INPUT_SRC_SEL_DMA     LCD_SPI_SRC_SEL(2)
#define LCD_SPI_INPUT_SRC_MASK        LCD_SPI_SRC_SEL(3)
...
#define LCD_SPI_RB_SWAP               BIT(4)
#define LCD_SPI_RB_SWAP_MASK          LCD_SPI_RB_SWAP(1)
...
/* Reg LCD_QSI_CMD{1} */
#define LCD_QSI_CMD(cmd, addr)       (((uint32_t)(cmd) << 24) | ((addr) & 0xffffff))

/* Reg LCD_QSI_QSYNC_TIM */
#define LCD_QSI_QSYNC_TIMING(hp, vfp, vbp) (((uint32_t)((hp) & 0xff) << 16) |  ((uint32_t)((vfp) & 0xff) << 8) | ((vbp) & 0xff))

/* Reg LCD_QSI_IMG_SIZE */
#define LCD_QSI_IMG_SIZE(w, h)  (((w) & 0x3ff) | ((uint32_t)((h) & 0x3ff) << 16))
